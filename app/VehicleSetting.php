...
class VehicleSetting extends Eloquent
{
	...
	protected $fillable = [
		...
		'zoom_factor_speed','zoom_factor_steer','train_view','motor_configuration','sound_level_factor',
        ...
        'max_rpm','upper_gear_shift_value','steer_angle_limit_per_100_ms','shift_value_race','cell_value_steer_pad','max_steering_angle','button_config_for_each_menu','motor_steps_for_max_steering',
