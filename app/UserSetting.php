...
class UserSetting extends Eloquent
{
	...
	protected $fillable = [
		...
		'zoom_factor_speed','zoom_factor_steer','train_view','car_short_id','sound_level_factor',
        ...
        'button_style','reverse_speed_motor','speed_motor_ma_limitation','steer_motor_ma_limitation','micro_steps','steering_control_point','firmware','rear_motor','motor_steps_for_max_steering','electric_motor_re_built',
        'upper_gear_shift_value','steer_angle_limit_per_100_ms','shift_value_race','cell_value_steer_pad','max_steering_angle','button_config_for_each_menu','max_rpm','screen_rotation_landscape',
        'from_id','setting_status','asset_folder','setting_art_no','setting_use_status','bar_code_id','pad_design_2_directional','motor_configuration','reverse_steer_motor','idle_rpm'
	];
