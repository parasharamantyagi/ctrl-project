...
class UserSetting extends Eloquent
{
	...
	protected $fillable = [
        ...
        'button_style','reverse_speed_motor','speed_motor_ma_limitation','steer_motor_ma_limitation','steering_control_point','firmware','rear_motor','motor_steps_for_max_steering','electric_motor_re_built',
