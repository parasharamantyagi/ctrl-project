...
class VehicleLogo extends JsonResource
{
    ...
    public function toArray($request)
    {
		$userData = array(
					...
					'pad4_image' => ($this->pad4_image && !empty($this->pad4_image)) ? $this->pad4_image : '',
					'larger_logo' => ($this->larger_logo && !empty($this->larger_logo)) ? $this->larger_logo : '',
					'full_screen_movie_links' => ($this->full_screen_movie_links && !empty($this->full_screen_movie_links)) ? $this->full_screen_movie_links : '',
					'video' => ($this->full_screen_movie_links && !empty($this->full_screen_movie_links)) ? $this->full_screen_movie_links : '',
