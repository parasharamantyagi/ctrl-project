...
<body>
	...
	var table = jexcel(document.getElementById('spreadsheet'), {
		data:data1,
		colHeaders: [ '<b>ID</b>','<b>BoardID</b>','<b>MOTOR ID <br/>DriverID</b>', '<b>TypeID</b>', '<b>Gear ratio<br/>(for stepper)</b>', '<b>Mode</b>','Value 1 (KMH/%)', 'Unit', 'Value 2 <br/>(PPS/Steps, time)' , 'Unit' , 'Value 1 (KMH/%)', 'Unit', 'Value 2 <br/>(time,mm)', 'Unit' ],
		nestedHeaders:[
			[
				{ title:''},
				{ title:''},
