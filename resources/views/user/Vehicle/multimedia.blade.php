		...
		<form method="POST" action="" id="Updateuser" enctype="multipart/form-data">
			...
			<div class="modal-header">
				...
				<div class="header-link">
						<a href="{{ url(user_role('multimedia/'.$setting_id)) }}" class="btn btn-secondary addvehicle-Button-config">Button config</a>
						<a href="{{ url(user_role('multimedia/'.$setting_id)) }}" class="btn btn-secondary addvehicle-Button-config">Multimedia</a>
				</div>
			</div>
								...
								<div class="row">
									<div class="column col-md-4">
										<div class="div_logo_image_image_130">
											<center>
											<div class="div_logo_image_image" style="max-width: 130px;height: 75px;">
