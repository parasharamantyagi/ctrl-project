...
<!-- Store CSRF token for AJAX calls -->
		...
		<link rel="stylesheet" type="text/css" href="{{ url('/assets/login/toastr.css') }}">
		<!-- Favicon and Apple Icons -->
		<link rel="shortcut icon" href="{{ url('ctrl-icon/ctrl_title3x.png') }}">
</head>
		<body>
...
<div class="logo">
			<a href="{{ url('/admin') }}"><img class="login-image-icone" alt="eBookBazaar" src="{{ url('ctrl-icon/ctrl_title3x.png') }}"></a>
		</div>			
<div class="login_innerdetails">
                    <form class="form-horizontal" role="form" method="POST" action="">
                        ...
                        <div class="form-group input-group">	
                            ...
                            <div class="col-md-12">
								<span class="input-group-addon"><img src="{{ url('ctrl-icon/email1.png') }}"></span>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
							<span class="input-group-addon"><img src="{{ url('ctrl-icon/lock1.png') }}"></span>
