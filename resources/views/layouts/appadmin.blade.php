...
<body>
    ...
    <li class=" xn-openable">
        <a href="{{ url('/admin/vehicle-info') }}"><i class="fa fa-car"></i> <span class="xn-text">VEHICLE INFO</span></a>
        <ul>
            <li class=""><a href="{{ url('/admin/vehicle-info/profile') }}">Profile</a></li>
            <li class=""><a href="{{ url('/admin/vehicle-info/profile-password-change') }}">Change Password</a></li>
        </ul>
    </li>
    <li class="">
	...
	<li class=" xn-openable {{ Request::segment(2) == 'users' ? 'active': '' }}">
