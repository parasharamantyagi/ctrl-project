...
<div class="col-md-12">
        <div class="panel panel-default">
            ...
            <h3 class="panel-title"><strong>{{ $page_info['page_title'] }}</strong></h3>                              
        </div>
						...
						<!tbody>
						  @foreach ($vehicles as $vehicle)
							<tr role="row">
								...
								<td>
									<a href="vehicle/{{$vehicle->_id}}" class="edit-user" data-id="{{ $vehicle->_id }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
									/ <a href="javascript::void(0)" class="delete-user" data-token="{{ csrf_token() }}" data-id="{{ $vehicle->_id }}"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
									/ <a href="vehicle-view/{{$vehicle->_id}}" class="edit-user" data-id="{{ $vehicle->_id }}"><i class="fa fa-eye" aria-hidden="true"></i></a>
								</td>
							</tr>
						  @endforeach
						</tbody>
