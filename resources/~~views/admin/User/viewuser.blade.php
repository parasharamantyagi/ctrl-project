						...
						<tbody>
						  @foreach ($users as $user)
							<tr role="row">
								...
								<td>
									<a href="users/{{$user->_id}}" class="edit-user" data-id="{{ $user->_id }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
									/ <a href="javascript::void(0)" class="delete-user" data-token="{{ csrf_token() }}" data-id="{{ $user->_id }}"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
								</td>
							</tr>
						  @endforeach
						</tbody>
